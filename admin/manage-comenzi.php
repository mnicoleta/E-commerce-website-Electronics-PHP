...
?>
<div class="container-fluid main-content pb-4 px-5">
  ...
  <div class="wrapper">
    ...
    <div class="btn-group btn-group-lg btn-center"  >
        <a href="#" class="btn btn-primary" >Comenzi</a>
    </div>
...
<?php
    ...
    <br>
<div class="container mx-1 my-4 px-3 " style="">
<table class="table table-sm table-striped table-bordered rounded bg-light "  style=" position:relative ;left:20px;
" >
 <thead>
    <tr>
        <th scope="col">Nr.</th>
        ...
        <th scope="col">Actiuni</th> 
            ...
            <?php
                ...
                ORDER BY idComanda, numeProdus ASC LIMIT 10
